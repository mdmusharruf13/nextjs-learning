...
It comes with some powerful features that make it perfect for modern web applications:
...
with Next.js you've got to protect you app form three different angles: client-side, server-side, and API routes.

Authentication G oals:

1. Lets users sign up.
2. Give them a way to sign in.
3. Enable them to manage their account (password change, email updates, etc).
